...
The source code is available [on github.com/gpandradep/CV](https://github.com/gpandradep/CV).
...
Mentoring & Academic Service {data-icon=user-graduate}
--------------------------------------------------------------------------------
...
```{r}
CV %<>% print_section('committees')
```

*Thesis Evaluation*

```{r}
CV %<>% print_section('evaluating')
```


Selected Conference Presentations {data-icon=person-chalkboard}
--------------------------------------------------------------------------------
...
Selected Grants, Fellowships, and Awards {data-icon=award}
--------------------------------------------------------------------------------
